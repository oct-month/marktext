    ...
    <compound>
      ...
      <template #children>
        ...
        <text-box
          ...
          notes="对于默认值，保留为空；否则使用带有单位后缀的数字，'ch'-字符大小、'px'-像素、'%'-百分比。（如'10ch'）"
